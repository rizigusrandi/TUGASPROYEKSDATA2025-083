...
<section class="hero" style="background-image: url('assets/img/all.jpg');">
    <div class="hero-content">
        <h1>ALL PRODUCTS</h1>
        <p>Our Shop's Best Products</p>
    </div>
</section>
...
<div class="search-container">
    <div class="search-box">
        <input type="text" id="searchInput" placeholder="🔍 Cari produk... (contoh: jacket, jeans, sneakers)">
